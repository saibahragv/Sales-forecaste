...
class ScenarioAdjustments(BaseModel):
    ...
    promotion_intensity: float = Field(0.0, ge=0.0, description="0..1 promotional intensity")
    macro_demand_shock_pct: float = Field(0.0, description="Percent shock applied to demand")
